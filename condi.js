...
var answer5 = prompt('What language do you use to add interactivity to a website? ');
...
if ( correct === 5) {
    ...
    document.write('<strong> You earned no crown. You need to study harder </strong>');
}