...
questions -= 1;
questionsLeft = " [" + questions + " questions left]";
var favStory = prompt(name + ' What is your favorite content creator on that app?' + questionsLeft);
questions -= 1;
questionsLeft = " [" + questions + " questions left]";

var time = prompt(name + ' How long do you spend your time on that app?' + questionsLeft);
